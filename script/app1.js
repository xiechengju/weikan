...
app_control.controller("recording",["$scope","$location", function ($scope,$location) {
    ...
    $scope.imgs = {
        ...
        srcs3:{ //数字互动
            list1:{bg:"img/p11/p11_h5_1.png",logo:"img/p11/h5_logo1.png",href:"http://a2designing.com/model/index.html", class:"pg1"},
            list2:{bg:"img/p11/p11_h5_2.png",logo:"img/p11/h5_logo2.png",href:"http://www.a2designing.cn/yashilan/heka/index.html", class:"pg2"},
            list3:{bg:"img/p11/p11_h5_3.png",logo:"img/p11/h5_logo3.png",href:"http://www.a2designing.com/z/index.html#page2", class:"pg3"},
            list4:{bg:"img/p11/p11_h5_4.png",logo:"img/p11/h5_logo4.png",href:"http://www.a2designing.cn/zhonghua/zhanlan20160303/", class:"pg4"},
            list5:{bg:"img/p11/p11_h5_5.png",logo:"img/p11/h5_logo5.png",href:"http://www.a2designing.cn/dow/dowlist/index.html", class:"pg5"}
        },
        srcs4:{ //空间展览
            list1:{bg:"img/p11/p11_3d1.png",logo:"img/p11/3d_logo1.png",href:"http://mp.weixin.qq.com/s?__biz=MzA3MDAwODg4Mw==&mid=400483308&idx=1&sn=19d4954c00ee379f2f21372d1b2f1362&scene=19#wechat_redirect", class:"pg1"},
            list2:{bg:"img/p11/p11_3d2.png",logo:"img/p11/3d_logo2.png",href:"http://mp.weixin.qq.com/s?__biz=MzA3MDAwODg4Mw==&mid=208533093&idx=1&sn=8f27a9015961aebaba9ad50d761f48d5&scene=19#wechat_redirect", class:"pg2"},
            list3:{bg:"img/p11/p11_3d3.png",logo:"img/p11/3d_logo3.png",href:"http://mp.weixin.qq.com/s?__biz=MzA3MDAwODg4Mw==&mid=202287225&idx=1&sn=fc20711e64d60114de9448d619198b4b&scene=19#wechat_redirect", class:"pg3"},
            list4:{bg:"img/p11/p11_3d4.png",logo:"img/p11/3d_logo5.png",href:"http://mp.weixin.qq.com/s?__biz=MzA3MDAwODg4Mw==&mid=401686179&idx=1&sn=11e02cb06b1d66e11be473ffdb521a01&scene=19#wechat_redirect", class:"pg4"},
            list5:{bg:"img/p11/p11_3d5.png",logo:"img/p11/logo08.png",href:"http://mp.weixin.qq.com/s?__biz=MzA3MDAwODg4Mw==&mid=502219658&idx=1&sn=bec0ddbda078c9b6943af9e4cca99353&scene=19#wechat_redirect", class:"pg5"},
            list6:{bg:"img/p11/p11_3d6.png",logo:"img/p11/3d_logo7.png",href:"http://mp.weixin.qq.com/s?__biz=MzA3MDAwODg4Mw==&mid=207633321&idx=1&sn=9029cf372e2288641afa331a096dc1d1&scene=19#wechat_redirect", class:"pg6"},
...
app.config(["$routeProvider",function ($routeProvider) {
    ...
    when("/catalog1",{templateUrl:"views/indexlist1.html",controller:function($scope){$scope.touchRemove();$scope.pageClass = $scope.classP.p2;$("body").css("background","white");$("title").html("爱图微官网");$scope.pageType=true;$scope.imgs.srcs=$scope.imgs.indexlist1;$scope.pageNumbers = {"width":$scope.pageNumber.indexlist1*100+"%"};$scope.pageNumbers.img = {"float":"left","width": 100/$scope.pageNumber.indexlist1+"%"}}}).
