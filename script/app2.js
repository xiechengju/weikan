...
app_control.controller("recording",["$scope","$location", function ($scope,$location) {
    ...
    $scope.imgs = {
        ...
        srcs3:{ //数字互动
            list15:{bg:"img/p11/p11_h5_15.png",logo:"img/p11/h5_logo3.png",href:"http://a2designing.cn/dsm/2016greeting/congratulation", class:"pg1"},
            list14:{bg:"img/p11/p11_h5_14.png",logo:"img/p11/h5_logo3.png",href:"http://a2designing.cn/Eastman/720/", class:"pg2"},
            list13:{bg:"img/p11/p11_h5_13.png",logo:"img/p11/h5_logo3.png",href:"http://www.a2designing.cn/danone/dngame", class:"pg3"},
            list12:{bg:"img/p11/p11_h5_12.png",logo:"img/p11/h5_logo3.png",href:"http://www.a2designing.cn/dow/shipgame", class:"pg4"},
            list11:{bg:"img/p11/p11_h5_11.png",logo:"img/p11/h5_logo3.png",href:"http://a2designing.cn/keshigame", class:"pg5"},
        ...
        srcs4:{ //空间展览
            list10:{bg:"img/p11/p11_3d10.png",logo:"img/p11/3d_logo1.png",href:"http://mp.weixin.qq.com/s/fCDHyJgcxLMNO6j5lbD1mg", class:"pg1"},
            list9:{bg:"img/p11/p11_3d9.png",logo:"img/p11/3d_logo1.png",href:"http://mp.weixin.qq.com/s/yHb_lu4zCFWgf4go0gCqew", class:"pg2"},
